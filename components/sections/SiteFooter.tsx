      ...
      <div className="relative z-10 mx-auto max-w-[1180px] px-4 sm:px-6 lg:px-8 py-12">
        <div className="rounded-3xl bg-[var(--card)] p-8 md:p-12 text-center shadow-[0_24px_70px_rgba(0,0,0,0.1)] transition-all duration-300 hover:shadow-[0_28px_80px_rgba(0,0,0,0.14)]">
          <a href="#top" className="inline-flex items-center gap-4 mb-8 group">
            <span className="inline-flex w-16 h-16 rounded-full bg-[var(--accent)] items-center justify-center text-white font-extrabold text-lg shadow-lg group-hover:scale-110 transition-transform duration-300">IF</span>
            <span className="text-3xl font-serif font-semibold tracking-tight">INFYTION PTE LIMITED</span>
          </a>
          ...
          <div className="mt-8 flex items-center justify-center gap-8">
            ...
            <a aria-label="Email" className="group text-[var(--muted)] hover:text-[var(--fg)] transition-all duration-300" href="mailto:contact@infytion.com">
          ...
          <div className="mt-6 pt-6 border-t border-[var(--border)]">
            <p className="text-[13px] text-[var(--muted)] font-semibold">
              62 UBI ROAD 1, #07-24, OXLEY BIZHUB 2<br />
              SINGAPORE (408734)
            </p>
          </div>
        </div>
      ...
      <div className="bg-[var(--bg)]">
        <div className="mx-auto max-w-[1180px] px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-[13px] text-[var(--muted)]">
          <div className="inline-flex items-center gap-3">
            <span className="inline-flex w-9 h-9 rounded-full bg-[var(--accent)] items-center justify-center text-white font-bold">IF</span>
            <span className="text-sm">INFYTION PTE LIMITED</span>
          </div>

          <div className="text-center">© {year} INFYTION PTE LIMITED</div>
